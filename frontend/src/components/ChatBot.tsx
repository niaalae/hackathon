...
const INITIAL_MESSAGE: Message = {
    id: '0',
    role: 'assistant',
    content: 'Hi! 👋 I\'m your Morocco travel assistant. Ask me anything about trips, riads, restaurants, or routes!',
}
...
export default function ChatBot() {
    ...
    return (
        <>
            ...
            {/* Chat window */}
            {open && (
                <div className="fixed bottom-20 right-5 z-[9999] flex h-[min(460px,calc(100vh-120px))] w-[min(360px,calc(100vw-40px))] flex-col overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-[0_16px_48px_rgba(0,0,0,0.12)]">
